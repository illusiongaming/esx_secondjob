...
function OpenCloakroomMenu()
	...
	ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'cloakroom',
	{
		title    = _U('cloakroom'),
		align    = 'bottom-right',
		elements = elements
		...
		if data.current.value == 'citizen_wear' then
			...
			if Config.EnableNonFreemodePeds then
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
					...
					TriggerEvent('skinchanger:loadpoliceModel', isMale, function()
...
function OpenArmoryMenu(station)
    ...
    ESX.UI.Menu.Open(
      'police', GetCurrentResourceName(), 'armory',
      {
        title    = _U('armory'),
        align    = 'bottom-right',
        elements = elements,
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'armory',
		{
			title    = _U('armory'),
        align    = 'bottom-right',
			elements = elements
...
function OpenVehicleSpawnerMenu(station, partNum)
	...
	if Config.EnableSocietyOwnedVehicles then
		...
		ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
			...
			ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'vehicle_spawner',
			{
				...
				ESX.Game.SpawnVehicle(vehicleProps.model, vehicles[partNum].SpawnPoint, vehicles[partNum].Heading, function(vehicle)
					...
					SetVehicleNumberPlateText(vehicle,"COP "..plate.." ")
				end)
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open(
	'police', GetCurrentResourceName(), 'police_actions',
	{
		title    = 'Police',
		align    = 'bottom-right',
		elements = {
		...
		if data.current.value == 'citizen_interaction' then
			...
			ESX.UI.Menu.Open(
			'police', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif data.current.value == 'dna' then
		...
		elseif data.current.value == 'vehicle_interaction' then
			...
			ESX.UI.Menu.Open(
			'police', GetCurrentResourceName(), 'vehicle_interaction',
			{
		...
		elseif data.current.value == 'object_spawner' then
			...
			'police', GetCurrentResourceName(), 'citizen_interaction',
			{
				...
				align    = 'bottom-right',
				elements = {
					{label = _U('cone'),			value = 'prop_fib_skylight_piece'},
					{label = _U('barriersmall'),	value = 'prop_mp_barrier_02b'},
					{label = _U('barrierbig'),		value = 'prop_mp_barrier_01b'},
					{label = _U('spikestrips'),		value = 'p_ld_stinger_s'},
					{label = _U('box'),				value = 'prop_boxpile_07d'},
					{label = _U('arrow'),			value = 'prop_mp_arrow_barrier_01'}
				}
			}, function(data2, menu2)
				...
				if model == 'prop_fib_skylight_piece' then
					z = z - 2.0
				end
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_policejob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'citizen_interaction',
		{
			title    = _U('citizen_interaction'),
			align    = 'bottom-right',
			elements = elements,
...
function OpenBodySearchMenu(player)
	...
	ESX.TriggerServerCallback('esx_policejob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'body_search',
		{
			title    = _U('search'),
			align    = 'bottom-right',
			elements = elements,
...
function OpenFineMenu(player)
	...
	ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'fine',
    {
      title    = _U('fine'),
      align    = 'bottom-right',
      elements = {
...
function OpenFineCategoryMenu(player, category)
	...
	ESX.TriggerServerCallback('esx_policejob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'fine_category',
		{
			title    = _U('fine'),
        		align    = 'bottom-right',
			elements = elements,
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_policejob:getOtherPlayerData', function(data)
		...
		ESX.UI.Menu.Open(
		'police', GetCurrentResourceName(), 'manage_license',
		{
...
function OpenUnpaidBillsMenu(player)
	...
	ESX.TriggerServerCallback('esx_billing:getTargetBills', function(bills)
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'billing',
		{
...
function OpenVehicleInfosMenu(vehicleData)
	...
	ESX.TriggerServerCallback('esx_policejob:getVehicleInfos', function(retrivedInfo)
		...
		ESX.UI.Menu.Open('police', GetCurrentResourceName(), 'vehicle_infos',
		{
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      'police', GetCurrentResourceName(), 'armory_get_weapon',
      {
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    'police', GetCurrentResourceName(), 'armory_put_weapon',
    {
...
function OpenBuyWeaponsMenu(station)
    ...
    ESX.UI.Menu.Open(
      'police', GetCurrentResourceName(), 'armory_buy_weapons',
      {
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_policejob:getStockItems', function(items)
    ...
    ESX.UI.Menu.Open(
      'police', GetCurrentResourceName(), 'stocks_menu',
      {
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, Keys['F9']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'police' and not ESX.UI.Menu.IsOpen('police', GetCurrentResourceName(), 'police_actions') then
			if Config.MaxInService == -1 then
